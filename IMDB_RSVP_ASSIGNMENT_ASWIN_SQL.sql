...
SELECT COUNT(movie_id) AS director_mapping
FROM director_mapping;
SELECT COUNT(movie_id) AS genre
FROM genre;
SELECT COUNT(id) AS movie
FROM movie;
SELECT COUNT(id) AS names
FROM names;
SELECT COUNT(movie_id) AS ratings
FROM ratings;
SELECT COUNT(movie_id) AS role_mapping
FROM role_mapping;
...
-- Type your code below:
SELECT SUM(ISNULL(title)) AS title,
       ...
       SUM(ISNULL(worlwide_gross_income)) AS worldwide_gross_income,
